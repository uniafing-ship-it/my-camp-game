...
const checks=new Map([
  ...
  ['V20.25 runtime preserves the V20.22 strategic agent',main.includes("runtimeVersion:'20.25.0'")&&main.includes("dataset.v20Agent='20.22'")&&main.includes("dataset.v20DecisionEngine='strategic-planner'")]
]);
